...
if __name__ == '__main__':
    ...
    autoencoder = Autoencoder(image_size=28, nz=opt.nz).to(device)
    criterion = nn.MSELoss()
    optimizer = optim.Adam(autoencoder.parameters(), lr=opt.lr, betas=(opt.beta1, 0.999))
    # optimizer = optim.SGD(autoencoder.parameters(), lr=opt.lr, momentum=0.9) # not work
